...
class _ScrollHeadState extends State<ScrollHead> {
  ...
  void didChangeDependencies() {
    ...
    _effectiveThemeData =
        _isMaterial3 ? SfPdfViewerThemeDataM3(context) : SfPdfViewerThemeDataM2(context);
  ...
  Widget build(BuildContext context) {
    ...
    final Alignment alignment = widget.scrollDirection == PdfScrollDirection.horizontal
        ? Alignment.bottomLeft
        : Alignment.topRight;
    return Align(
      alignment: alignment,
